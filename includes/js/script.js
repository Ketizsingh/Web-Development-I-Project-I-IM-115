...
function barmove(start,end)                   /* function name barmove */
{
  var elem = document.getElementById("myBar");     /* gets element in survey.html using getElementById */  
  var width = start;
...
function next_question(values)            /* function next_question */
{
                                /* gets element in survey.html and display becomes available on questions */
  if (values == '1')
  {
